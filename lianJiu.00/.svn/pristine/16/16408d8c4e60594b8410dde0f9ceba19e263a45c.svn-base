...
// 日志输出
#ifdef DEBUG
#define MJRefreshLog(...) HZLog(__VA_ARGS__)
#else
#define MJRefreshLog(...)
#endif
...
UIKIT_EXTERN NSString * MJRefreshHeaderIdleText;
UIKIT_EXTERN NSString * MJRefreshHeaderPullingText;
UIKIT_EXTERN NSString * MJRefreshHeaderRefreshingText;

UIKIT_EXTERN NSString * MJRefreshAutoFooterIdleText;
UIKIT_EXTERN NSString * MJRefreshAutoFooterRefreshingText;
UIKIT_EXTERN NSString * MJRefreshAutoFooterNoMoreDataText;

UIKIT_EXTERN NSString * MJRefreshBackFooterIdleText;
UIKIT_EXTERN NSString * MJRefreshBackFooterPullingText;
UIKIT_EXTERN NSString * MJRefreshBackFooterRefreshingText;
UIKIT_EXTERN NSString * MJRefreshBackFooterNoMoreDataText;
