...
//  XWCountryCodeDemo
//
//  Created by wanglinlei on 16/9/19.
//  Copyright © 2016年 wanglinlei. All rights reserved.
//
...
//    NSString *plistPathFAN = [[NSBundle mainBundle] pathForResource:@"sortedFanames" ofType:@"plist"];
//    NSString *plistPathHAN = [[NSBundle mainBundle] pathForResource:@"sortedHanames" ofType:@"plist"];
//    NSString *plistPathRI = [[NSBundle mainBundle] pathForResource:@"sortedRInames" ofType:@"plist"];
...
//       //繁体
//        sortedNameDict = [NSDictionary dictionaryWithContentsOfFile:plistPathFAN];
//    }else if([[InternationalControl userLanguage] isEqualToString:@"en"]){
//      //英文
//        sortedNameDict = [NSDictionary dictionaryWithContentsOfFile:plistPathEN];
//    }else if([[InternationalControl userLanguage] isEqualToString:@"ja"]){
//       //日本
//        sortedNameDict = [NSDictionary dictionaryWithContentsOfFile:plistPathRI];
//    }else if([[InternationalControl userLanguage] isEqualToString:@"ko"]){
//      //韩文
//        sortedNameDict = [NSDictionary dictionaryWithContentsOfFile:plistPathHAN];
//    }
//    
...
//    [self dismissViewControllerAnimated:YES completion:nil];
    ...
    if (self.returnCountryCodeBlock != nil) {
        self.returnCountryCodeBlock([[cell.textLabel.text componentsSeparatedByString:@" "]lastObject]);
    }
    [self dismissViewControllerAnimated:YES completion:nil];
}
#pragma mark - 代理传值
