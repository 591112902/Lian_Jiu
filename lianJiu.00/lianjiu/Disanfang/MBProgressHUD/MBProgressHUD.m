...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:attribute];
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    ...
    if (isIOS7) {
        NSDictionary * dic = [NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName,nil];
        detailsLabelSize =[detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin  attributes:dic context:nil].size;
    }else
    {
