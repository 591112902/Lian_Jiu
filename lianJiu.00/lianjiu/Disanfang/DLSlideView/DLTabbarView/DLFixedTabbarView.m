...
- (void)commonInit{
    ...
    UIView *trackbgview=[[UIView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-kTrackViewHeight, self.bounds.size.width, kTrackViewHeight)];
    trackbgview.backgroundColor = [UIColor clearColor];
