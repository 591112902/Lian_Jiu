...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        _tableView.frame = CGRectMake(0, 0, tableViewH, ScreenH  - 50-64-44);
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(tableViewH, 0, ScreenW - tableViewH, ScreenH  - 50-64-44);
        //注册Cell
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ChooseAssessVC *goodSetVc = [[ChooseAssessVC alloc] init];
