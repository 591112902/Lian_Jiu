...
@interface SellScrapVC ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
{
...
- (void)viewDidLoad {
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40+64, BOUND_WIDTH, BOUND_HIGHT-TARBARHEIGHT-40-64) collectionViewLayout:flowLayout];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    scrapVC.title = model.categoryName;
