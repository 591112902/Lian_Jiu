...
@interface PRJTabBarButton()
/**
 *  提醒数字
 */
@property (nonatomic, weak) PRJBadgeButton *badgeButton;
@end

@implementation PRJTabBarButton
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 文字颜色
        [UIColor colorWithRed:122 green:219 blue:76 alpha:1];
        
         [self setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
         [self setTitleColor:[UIColor colorWithRed:4/255.0 green:209/255.0 blue:2/255.0 alpha:1.0] forState:UIControlStateSelected];
...
//        }
        ...
        //[self setBackgroundImage:[UIImage imageNamed:@"l_tb_bg"] forState:UIControlStateSelected];
        
        // 添加一个提醒数字按钮
        self.imageView.contentMode = UIViewContentModeScaleAspectFit;
        PRJBadgeButton *badgeButton = [[PRJBadgeButton alloc] init];
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect
{
    ...
    CGFloat imageH = contentRect.size.height * IWTabBarButtonImageRatio-5;
