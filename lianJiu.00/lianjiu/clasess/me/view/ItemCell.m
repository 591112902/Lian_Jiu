...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _icon = [[UIImageView alloc] initWithFrame:CGRectMake((containerW - 25) / 2, 30, 25, 25)];
...
//        //背景色
//        UILabel*  label = [[UILabel alloc] initWithFrame:CGRectMake(0, self.bounds.size.width-1, self.bounds.size.width, 1)];
