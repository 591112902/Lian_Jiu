...
@interface GoodsOrderViewController ()<DLTabedSlideViewDelegate>
...
//    childrenVCs = [[NSMutableArray alloc] init];
   ...
   // @[@"快递回收",@"jiesuan",@"jiesuanS"],;
    controllers = @[@[@"",@"Gdaifukuan",@"GdaifukuanS"],@[@"",@"Gdaifahuo",@"GdaifahuoS"],@[@"",@"Gdaishouhuo",@"GdaishouhuoS"],@[@"",@"Gpingjia",@"GpingjiaS"],@[@"",@"Gtuihuo",@"GtuihuoS"],];//5个--文字:图片
...
- (UIViewController *)DLTabedSlideView:(DLTabedSlideView *)sender controllerAt:(NSInteger)index{
    ...
    GoodOrderManageTVController *controller = [[GoodOrderManageTVController alloc] initWithStyle:UITableViewStyleGrouped];
